...
<div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="bg-white dark:bg-neutral-700 rounded-xl shadow-md p-6 mb-8">
            ...
            <div class="w-full bg-gray-200 dark:bg-gray-300 rounded-full h-4">
                <div class="h-4 rounded-full transition-all duration-300 {{ $this->overallPercentage > 100 ? 'bg-red-500' : ($this->overallPercentage > 90 ? 'bg-orange-500' : ($this->overallPercentage > 80 ? 'bg-yellow-500' : 'bg-green-500')) }}"
                    style="width: {{ min($this->overallPercentage, 100) }}%"></div>
            </div>
        </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                @foreach($this->budgets as $budget)
                    <div class="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-xl transition"
                        ...
                        <!-- Card Header -->
                        <div class="p-6 {{ $budget->category ? '' : 'bg-gradient-to-r from-gray-500 to-gray-600' }}"
                            @if($budget->category)
                        ...
                        <!-- Card Body -->
                        <div class="p-6 space-y-4 dark:bg-neutral-300">
                            <!-- Amount -->
                            <div class="flex items-center justify-between">
