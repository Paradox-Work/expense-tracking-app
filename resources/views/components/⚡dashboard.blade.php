    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            ...
            <div class="bg-white dark:bg-neutral-700 rounded-xl shadow-md p-6 border-l-4 border-purple-500">
                ...
                <div class="text-3xl font-bold text-gray-800 dark:text-white">${{ number_format($totalSpent, 2) }}</div>
                @if($monthlyBudget > 0)
             ...
             <!-- Budget Card -->
            <div class="bg-white dark:bg-neutral-700 rounded-xl shadow-md p-6 border-l-4 border-blue-500">
                <div class="flex items-center justify-between mb-2">
                    <h3 class="text-sm font-medium text-gray-600 dark:text-gray-300">Monthly Budget</h3>
                ...
                <div class="text-3xl font-bold text-gray-800 dark:text-white">${{ number_format($monthlyBudget, 2) }}</div>
                @if($monthlyBudget > 0)
                    <div class="mt-3">
            ...
            <div class="bg-white dark:bg-neutral-700 rounded-xl shadow-md p-6 border-l-4 border-green-500">
                <div class="flex items-center justify-between mb-2">
                    <h3 class="text-sm font-medium text-gray-600 dark:text-gray-300">Categories</h3>
                ...
                <div class="text-3xl font-bold text-gray-800 dark:text-white">{{ $expenseByCategory->count() }}</div>
                <div class="mt-2 text-sm text-gray-600 dark:text-gray-400">Active spending categories</div>
            </div>
            <!-- Recurring Card -->
            <div class="bg-white dark:bg-neutral-700 rounded-xl shadow-md p-6 border-l-4 border-orange-500">
                <div class="flex items-center justify-between mb-2">
                    <h3 class="text-sm font-medium text-gray-600 dark:text-gray-300">Recurring</h3>
                ...
                <div class="text-3xl font-bold text-gray-800 dark:text-white">{{ $recurringExpenseCount }}</div>
                <div class="mt-2 text-sm text-gray-600 dark:text-gray-400">Active subscriptions</div>
            </div>
        </div>
        <!-- Charts Row -->
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
            ...
            <div class="bg-white dark:bg-neutral-700 rounded-xl shadow-md p-6">
                <h3 class="text-lg font-semibold text-gray-800 dark:text-gray-300 mb-4">6-Month Spending Trend</h3>
                <canvas id="monthlyTrendChart"></canvas>
            </div>
            <div class="bg-white dark:bg-neutral-700 rounded-xl shadow-md p-6">
                <h3 class="text-lg font-semibold text-gray-800 dark:text-gray-300 mb-4">Spending by Category</h3>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <!-- Top Categories -->
            <div class="bg-white dark:bg-neutral-700 rounded-xl shadow-md p-6">
                <h3 class="text-lg font-semibold text-gray-800 dark:text-gray-300 mb-4">Top Spending Categories</h3>
                <div class="space-y-4">
                    @forelse($topCategories as $category)
                        <div class="flex items-center justify-between">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    <div class="font-medium text-gray-800 dark:text-gray-300">{{ $category->name }}</div>
                            ...
                            <div class="text-right">
                                <div class="font-bold text-gray-800 dark:text-white">${{ number_format($category->total, 2) }}</div>
                            </div>
                        </div>
                    @empty
                        <div class="text-center text-gray-500 py-8 dark:text-gray-300">
            ...
            <div class="bg-white dark:bg-neutral-700 rounded-xl shadow-md p-6">
                <div class="flex items-center justify-between mb-4">
                    <h3 class="text-lg font-semibold text-gray-800 dark:text-gray-300">Recent Expenses</h3>
                    ...
                    @forelse($recentExpenses as $expense)
                        <div class="flex items-center justify-between py-3 border-b border-gray-100 last:border-0">
                            <div class="flex items-center gap-3">
                                ...
                                @endif
                                <div>
                                    <div class="font-medium text-gray-800 dark:text-gray-300">{{ $expense->title }}</div>
                                    <div class="text-sm text-gray-500 dark:text-gray-400">{{ $expense->date->format('M d, Y') }}</div>
                                </div>
                            </div>
                            <div class="text-right">
                                <div class="font-bold text-gray-800 dark:text-white">-${{ number_format($expense->amount, 2) }}</div>
